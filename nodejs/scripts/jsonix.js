...
if (typeof require === 'function') {
	...
	if (typeof define !== 'function') {
		...
		if (typeof window === 'undefined')
		{
			// Require @xmldom/xmldom, xmlhttprequest and fs
			define(["@xmldom/xmldom", "xmlhttprequest", "fs"], _jsonix_factory);
		}
		else
		{
			// We're probably in browser, maybe browserify
			// Do not require @xmldom/xmldom, xmlhttprequest as they'r provided by the browser
		...
		// Load the module without @xmldom/xmldom and xmlhttprequests dependencies
		define([], _jsonix_factory);
	}
}
